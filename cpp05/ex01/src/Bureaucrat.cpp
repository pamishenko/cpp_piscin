...
/*   Updated: 2022/03/21 22:10:47 by ttanja           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(Form &form)
{
	...
	{
		std::cerr << RED << _name << " couldn’t sign " << form.getName() << " because "<< ex.what() << END_COLOR << std::endl;
		return ;
	}
	std::cout	<< GREEN << _name << " signed " << form.getName() << END_COLOR << std::endl;
}
